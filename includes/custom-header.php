 ...
 *
 * @uses foodie_header_style()
 * @uses foodie_admin_header_style()
 * @uses foodie_admin_header_image()
 *
 * @package Foodie
 */
function foodie_custom_header_setup() {
	if ( function_exists( 'add_theme_support' ) ) {
		add_theme_support( 'custom-header', apply_filters( 'foodie_custom_header_args', array(
			'default-image'          => '',
...
add_action( 'after_setup_theme', 'foodie_custom_header_setup' );
